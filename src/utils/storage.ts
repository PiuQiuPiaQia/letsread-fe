...
const REMEMBER_KEY = "rememberMe"//记住密码
...
export const getLocalRememberMe = () => {
    ...
    return rememberStatus==="true"?true:false
}
export const removeLocalRememberMe = () => localStorage.removeItem(REMEMBER_KEY)

//保存用户名
export const setLocalUsername = (username) => localStorage.setItem(USERNAME, username)
...
//保存密码
export const setLocalPassword = (password) => localStorage.setItem(PASSWORD, password)
